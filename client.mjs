...
export class Fluye {
    ...
    constructor(options = {}) {
        ...
        this.#user = new FluyeUser(this);
        this.#session = new FluyeSession(this);
    }
...
class Data {
    ...
    async get(key) {
        let me = this;
        if (!me.#cache) {
            let res = await me.#fluye.fetch(me.#path);
            let data = await res.json();
...
class FluyeUser {
    data;
    constructor(fluye) {
        this.data = new Data(fluye, '/user/data');
    }
}
...
class FluyeSession {
    data;
    constructor(fluye) {
        this.data = new Data(fluye, '/session/data');
    }
}
